...
public class StatesResource {
    ...
    public Response getPeachStates() {
        ...
        try {
            ...
            Response all = retrieveAllStates();

            if (all != null && all.getRestResponse() != null && all.getRestResponse().getResult() != null) {
                ...
                for (Result state : all.getRestResponse().getResult()) {
                    if (state != null) {
                        if (Constants.ALABAMA.equalsIgnoreCase(state.getName()) 
                                || Constants.GEORGIA.equalsIgnoreCase(state.getName())) {
    ...
    /**
     * Build a response containing a polite error message indicating something
     * went wrong
     * 
     * @return Response
     */
